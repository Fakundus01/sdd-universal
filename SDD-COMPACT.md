# SDD-COMPACT v0.7 · cheat-sheet universal (cuadro de sintaxis)
...
R17 security:      secretos ⇒ .env (gitignoreado); revisar diff pre-commit; datos de terceros documentados
